...
public class JoinQuery<T, M> {
	 ...
	 * @desc:
	 *        <li>判断并分割：前端传递的quaryString字符串内容
	 */
	 ...
	 * @desc:
	 *        <li>转换为mybatisPlus之QueryWrapper需求：构建where 条件
	 */
	 ...
	 * @Desc:
	 *        <li>查找实体类clazz 中带有某个注解[ann]的字段集合
	 *        <li>包括其父类上的
	 */
	 ...
	 * @Desc:
	 *        <li>分析 ParmModel.quaryString 格式，获取“.”后面的字符串：即子表在sql中的别名
